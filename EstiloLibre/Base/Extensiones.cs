...
public static class Extensiones
{
    ...
    public static IApplicationBuilder UsarBlazorFrameworkFiles(this IApplicationBuilder builder, PathString pathPrefix)
    {
    ...
    /// <returns>The <see cref="IApplicationBuilder"/></returns>
    public static IApplicationBuilder UsarBlazorFrameworkFiles(this IApplicationBuilder applicationBuilder) =>
        UsarBlazorFrameworkFiles(applicationBuilder, default);
